...
function RacerRedes() {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-[#1dd1a1]/30 bg-gradient-to-r from-[#1dd1a1]/20 via-[#2d3436] to-[#2d3436] p-6">
        <p className="text-xs uppercase tracking-[0.25em] text-[#1dd1a1]">Racer Redes</p>
        <h1 className="mt-2 text-3xl font-black text-white">Central de Conteúdo Automático</h1>
        <p className="mt-2 text-[#b2bec3]">
          Crie descrição inteligente com SPIN Selling e gere vídeos com legendas sempre ativas.
        </p>
      </div>

      {error && (
        <div className="rounded-xl border border-red-500/30 bg-red-500/10 p-4 text-sm text-red-200 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div className="xl:col-span-1 rounded-2xl border border-white/10 bg-[#2d3436] p-5">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-bold text-white">Template Comercial</h2>
          ...
          <div className="space-y-3">
            {templateOptions.map((item) => (
              ...
              >
                ...
                <p className="text-xs text-[#b2bec3] mt-1">{item.hook}</p>
              </button>
            ))}
          </div>
          <div className="mt-4 rounded-xl border border-white/10 bg-black/25 p-3 text-xs text-[#b2bec3]">
        ...
        <div className="xl:col-span-2 rounded-2xl border border-white/10 bg-[#2d3436] p-5 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-bold text-white">Descrição Inteligente + Geração</h2>
            <button
              onClick={loadVehicles}
              className="text-xs px-3 py-2 rounded-lg bg-[#1dd1a1] text-black font-bold hover:brightness-110 transition"
            >
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-white/10 hover:bg-white/15 px-4 py-2 text-sm font-bold text-white transition"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-[#1dd1a1] hover:brightness-110 px-4 py-2 text-sm font-black text-black transition disabled:opacity-60"
            >
          ...
          <div className="rounded-xl border border-white/10 bg-black/20 p-4">
            <p className="text-xs uppercase tracking-widest text-[#b2bec3] mb-2">Prévia de Narração</p>
          ...
          {job && (
            <div className="rounded-xl border border-white/10 bg-black/20 p-4">
              <p className="text-xs uppercase tracking-widest text-[#b2bec3] mb-2">Status da Geração</p>
              ...
              {job.video_url && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-3 inline-flex items-center gap-2 text-[#1dd1a1] hover:underline text-sm font-semibold"
                >
